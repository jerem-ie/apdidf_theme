	...
	<div id="header-wrap">
    	<?php wpex_hook_header_before(); ?>
        	<div id="pre-header" class="clearfix">
                <ul>
                <li><a class="animateurs" href="<?php echo site_url(); ?>/animateurs" title="Lien vers la Page Animateurs">Animateurs</a> | <a class="elus" href="<?php echo site_url(); ?>/elus" title="Lien vers la Page Elus">Elus</a> | <a class="permanents" href="<?php echo site_url(); ?>/permanents" title="Lien vers la Page Permanents">Permanents </li>
                </ul>
