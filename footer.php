...
<?php wpex_hook_content_after(); ?>
	...
	<div id="copyright">&copy; <?php _e('Copyright','wpex'); ?> <?php the_date('Y'); ?> &middot; <a href="<?php echo home_url(); ?>" title="<?php bloginfo('name'); ?>"><?php bloginfo('name'); ?></a> - Information sur  <a href="http://apdidf.org/theme" title="WPExplorer" target="_blank" rel="nofollow">ce Theme</a></div>
</div><!-- /wrap -->
