...
<div id="commentsbox" class="boxframe">
	<div id="comments" class="comments-area clearfix">
        ...
        <?php // You can start editing here -- including this comment! ?>
         ...
         <!-- Check if user is logged in. and display form -->
        <?php if (! is_user_logged_in()) : ?>
        
        <h3 class="comments-title"><span>Comment Participer ?</span></h3>
            <p>Tout le monde est libre de répondre à cette proposition.</p>
            <p>Si vous êtes membre de l'association, <a href="<?php wp_login_url( apply_filters( 'the_permalink', get_permalink() ) ) ; ?>"> connectez-vous pour repondre</a>. Sinon, utilisez le formulaire ci-dessous</p>
        ...
        <!-- Pourvu = indique qu'il n'est pas possible de postuler pour le moment-->
        
        <?php if(comments_open()&& in_category('pourvu') && '3' != get_comments_number()) { ?>
